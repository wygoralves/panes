...
pub fn insert_user_message(db: &Database, thread_id: &str, content: &str) -> anyhow::Result<MessageDto> {
  insert_message(db, thread_id, "user", Some(content.to_string()), None, MessageStatusDto::Completed)
}
