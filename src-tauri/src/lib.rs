...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::git::drop_git_stash,
            commands::git::merge_branch,
            commands::git::merge_abort,
            commands::git::continue_merge,
            commands::git::get_repo_state,
            commands::git::get_github_pr_url,
            commands::git::get_github_repo_url,
            commands::git::revert_commit,
            commands::git::cherry_pick_commit,
            commands::git::reset_to_commit,
            commands::git::list_git_tags,
